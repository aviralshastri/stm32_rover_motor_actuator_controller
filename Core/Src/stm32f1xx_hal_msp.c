...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, Motor_B1_Pin|Motor_B2_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    HAL_GPIO_DeInit(GPIOA, Motor_C1_Pin|Motor_C2_Pin);

    HAL_GPIO_DeInit(GPIOB, Motor_D1_Pin|Motor_D2_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB9     ------> TIM4_CH4
    */
    HAL_GPIO_DeInit(GPIOB, Motor_A1_Pin|Motor_A2_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, Input_UART_Pin|Input_UARTB11_Pin);
